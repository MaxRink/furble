...
constexpr SettingSchema SETTING_SCHEMAS[] = {
    ...
    {51,                         ValueType::BOOL,   1,  1                           },
    {52,                         ValueType::STRING, 1,  MAX_WIFI_SSID_BYTES         },
    {53,                         ValueType::STRING, 0,  MAX_WIFI_PSK_BYTES          },
    {54,                         ValueType::BOOL,   1,  1                           },
    {55,                         ValueType::STRING, 1,  MAX_STRING_BYTES            },
    {56,                         ValueType::BOOL,   1,  1                           },
    {57,                         ValueType::STRING, 0,  MAX_MQTT_FIELD_BYTES        },
    {58,                         ValueType::STRING, 0,  MAX_MQTT_FIELD_BYTES        },
