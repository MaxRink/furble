...
- `lib/furble/protocol/ProvisionTLV` mirrors the frozen settings wire ledger.
  Wire ID 45 is reserved for IMU and wire ID 46 is the write-only companion
  password. Keep duplicate password representations rejected before apply.
