...
| Ricoh | Ricoh GR IV series. Shutter capture with autofocus and GPS supported. Focus-only control is unsupported. Does not work with GR III or GR II. Numeric-comparison pairing shows the six-digit code on the furble display. |
