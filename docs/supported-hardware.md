...
| :--- | :--- | :--- | :--- | :--- | :--- |
| GPS/BDS Unit v1.1 | AT6668 | Ceramic patch (built in) | All five | Grove Port A | Protocol-supported; live hardware verification pending. Indoor reception is expected to be marginal because of the patch antenna. |
