...
inline int mbedtls_entropy_func(void *, unsigned char *, size_t) {
  return 0;
}
...
inline const void *mbedtls_pk_info_from_type(int) {
  return nullptr;
}
inline int mbedtls_pk_setup(mbedtls_pk_context *, const void *) {
  return 0;
}
...
inline int mbedtls_x509write_crt_set_subject_name(mbedtls_x509write_cert *, const char *) {
  return 0;
}
inline int mbedtls_x509write_crt_set_issuer_name(mbedtls_x509write_cert *, const char *) {
  return 0;
}
inline int mbedtls_x509write_crt_set_serial_raw(mbedtls_x509write_cert *,
                                                const unsigned char *,
                                                size_t) {
  return 0;
}
inline int mbedtls_x509write_crt_set_validity(mbedtls_x509write_cert *,
                                              const char *,
                                              const char *) {
  return 0;
}
inline int mbedtls_x509write_crt_set_basic_constraints(mbedtls_x509write_cert *, int, int) {
  return 0;
}
inline int mbedtls_x509write_crt_set_key_usage(mbedtls_x509write_cert *, unsigned) {
  return 0;
}
inline int mbedtls_x509write_crt_pem(mbedtls_x509write_cert *,
...
inline int mbedtls_base64_decode(unsigned char *output,
                                 size_t outputSize,
                                 size_t *outputLength,
