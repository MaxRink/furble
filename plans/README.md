...
| [166-console-workflow-coverage.md](166-console-workflow-coverage.md) | Every UI workflow scriptable from the USB console through the same production request path, starting with pairing a scanned camera |
