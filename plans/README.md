...
| [165-sim-no-touch-layout.md](165-sim-no-touch-layout.md) | Certified simulator coverage of the physical-button layout the Stick boards ship, plus an indicator-clearance query and the layout gaps it exposes |
